...
func asFloat(v core.Value, fnName string) (float64, error) {
	...
	case core.VInt:
		return float64(v.GetInt()), nil
	}
	return 0, fmt.Errorf("%s: expected number, got %s", fnName, v.Inspect())
}

func mathSqrt(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
...
func mathPow(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 2 {
...
func mathLog(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
...
func mathLog2(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
...
func mathLog10(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
...
func mathFloor(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
...
func mathCeil(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
...
func mathRound(args []core.Value, scope core.Scope) (core.Value, error) {
	if len(args) != 1 {
